...
const AddCategory = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!categoryName) {
      // categoryImage is now optional due to UI update, but backend might require it
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4">
      <div className="w-full max-w-2xl bg-white shadow-xl rounded-lg p-8">
        <div className="mb-6 flex justify-between items-center">
          ...
          <Link
            to={"/admin/categories"}
            className="bg-gray-800 text-white px-4 py-2 rounded-md shadow-md hover:bg-gray-700 transition duration-300"
          >
            Back
          </Link>
        </div>
